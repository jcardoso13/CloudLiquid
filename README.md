...
```
cd existing_repo
git remote add origin https://umane.emeal.nttdata.com/git/ClustersAREASOFEXPER/composable-arquitectures/initiatives/cloud-liquid/cloud-liquid-framework.git
git branch -M main
...
- [ ] [Set up project integrations](https://umane.emeal.nttdata.com/git/ClustersAREASOFEXPER/composable-arquitectures/initiatives/cloud-liquid/cloud-liquid-framework/-/settings/integrations)
